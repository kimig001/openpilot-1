...
def check_car_battery_voltage(should_start, health, charging_disabled, msg):
  ...
  if charging_disabled and (health is None or health.health.voltage > (int(12200)+500)) and msg.thermal.batteryPercent < int(60):
    charging_disabled = False
    os.system('echo "1" > /sys/class/power_supply/battery/charging_enabled')
  elif not charging_disabled and (msg.thermal.batteryPercent > int(70) or (health is not None and health.health.voltage < int(12200) and not should_start)):
